...
Primero vamos a instalar PySerial. Es un modulo para conectar nuestro Launchpad a python. En internet existe un monton de documentacion a respecto.

Nosotros estamos con Ubuntu y tenemos el paquete oficial que puede ser facilmente instalado con el siguiente comando:
