...
\begin{figure}[h!]
		\includegraphics[scale=0.3]{imagenes/TIVA-MPU.JPG}
		\label{fig:5}
		\centering
		\caption{Conexion IMU a Tiva C Launchpad}
\end{figure}

A continuación necesitamos añadir las librerías (las tenemos dentro del paquete también) al para que el código funcione. A continuación, copiamos el código y compilamos y pasamos a la placa. Primero comprbaremos con el monitor serie del energia. Y segundo comprobaremos ejecutando el código del py_serial que esta en la carpeta interface. 
