...
\subsection{Paquete ROS, Python, OpenCV(cv\_bridge) y Kinect.}
...
\subsubsection{Arrancar driver OpenNi/Freenect}
...
\subsubsection{Crear paquete de ROS}
...
\subsubsection{Código para mostrar imágenes}
...
\subsection{Conectando Tiva C con LaunchPad with Python}
...
A continuación mostramos el código y podemos comprobar como funciona:
...
\section{IMU Sensor MAgnetico Inercial}
...
A continuación vamos a comprobar como funciona nuestro IMU. Lo primero que vamos a hacer es mostrar el esquema de como debemos de conectar el sensor a nuestra placa.

\begin{figure}[h!]
		\includegraphics[scale=0.3]{imagenes/energia_library.jpg}
		\label{fig:5}
		\centering
		\caption{Energia añadiendo librerías}
\end{figure}

A continuación necesitamos añadir las librerías para poder compilar el proyecto. Las librerias las podeis encontrar en mis repositorios del github  \url{https://github.com/m-sanchez-rico/tiva_code/tree/master/Libraries}. Para añadir las librerías, abrimos energia y vamos a programa - Incluir libreria - Añadir Libreria ZIP.

A continuación, copiamos el código y compilamos y pasamos a la placa. Primero comprobaremos con el monitor serie del energia. Y segundo comprobaremos ejecutando el código del pyserial que esta en la carpeta interface. Para ver la lectura en ros solo tenemos que ejecutar el script como hicimos en el caso del ultrasonido.
