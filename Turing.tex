...
\item Vamos a Archivo -> Ejemplos -> 1.Basics -> Fade. Se nos abrirá el codigo y le echamos un ojo.
\item Hacemos click en el boton compilar, y si todo va bien veremos en la parte inferior un mensaje del compilador indicando el tamaño del codigo.
\item Presionamos el boton subir y si todo va bien veremos en la consola inferion el mesaje de \textit{Succes}.
\item Disfrutar del nuevo codigo añadido a la placa.
\end{enumerate}

Tras estos test, sabemos que nuestra placa funciona, es reconocida por el ordenador y que podemos subir nuevo codigo.
