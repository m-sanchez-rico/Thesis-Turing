...
PCL tiene una licencia BSD. Es Open Source, gratis para comercio y para uso en investigación. PCL es multiplataorma y esta perfectamente compilado y depurado en Linux, Mac OS X, Windows y Android. Se puede descargar desde la siguente direccion: http://pointclouds.org/downloads/

PCL esta totalmente integrado dentro de ROS. La libreria PCL y su interfaz con ROS se instala justo a la instalacion del ROS full desktop, ya lo comentamos en capitulo anteriores. Con la siguente direccion podemos seguir investigando sobre ROS y PCL: http://wiki.ros.org/pcl.
...
\item Fácil de programar con un IDE llamado Energia (http://energia.nu/).
\end{itemize}
...
Es importante conocer la lista de pines de la placa, adjuntamos a continuación el enlace donde podemos consultarlo, http://energia.nu/pinmaps/ek-tm4c123gxl/. En el documento de anoxos podemos ampliar informacion sobre pins etc.

\subsection{Installing the Energia IDE}

Para descargar el IDE de programacion que vamos a utilizar, tenemos que acceder a la siguiente pagina Web: http://energia.nu/download/ y nos descargamos el instalador para linux 64Bits.

A continuacion accedemos a la siguiente ruta para conocer los detalles de la instalacion: http://energia.nu/guide/install/linux/.

Los pasos son los siguientes:

\begin{enumerate}
\item Descargamos de http://energia.nu/download/ el software para linux 64 bits. En mi caso se llama \textit{energia-1.8.7E21-linux64.tar.xz}, acemos clic con boton derecho y descomprimimos.
...
\item A continuacion vamos a la siguiente pagina: http://energia.nu/guide/install/linux/ Acemos clic en el enlace \textit{TI udev rules} y descargamos el fichero.
...
La descripcion de los pines es la siguiente:
