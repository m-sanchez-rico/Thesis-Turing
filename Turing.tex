...
Esto es una prueba haber si .git ignore elimina no hace el commit de la carpeta buit Las lecturas realizadas para para documentar los siguientes capitulos se han extraido de~\cite{1} y~\cite{2}
