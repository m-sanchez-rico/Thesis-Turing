...
\begin{figure}[h!]
		...
		\includegraphics{imagenes/tree_package_turing_opencv.png}
		\label{fig:5}
		\centering
\end{figure}
...
Los sensores ultrasonidos, los vamos a utilizar para medir las distacias a los objetos que encontremos y ser capaces de esquibar los obstaculos que encontrmos en el camino. El modelo de sensores 
